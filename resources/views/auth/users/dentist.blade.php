<div class="tab-pane fade show" id="dentist" role="tabpanel" aria-labelledby="dentist-tab">
    <div class="card-body">
        <form method="POST" action="{{ route('register') }}">
                ...
                <div class="col-md-6">
                    <select multiple="multiple"
                        ...
                        @foreach ($specializations as $key => $specialization)
                            @if($specialization->type == 2 || $specialization->type == 0)
            ...
            <div class="form-group row">
                <label for="specializationsp" class="col-md-4 col-form-label text-md-right"><i class="fas fa-diagnoses"></i>&nbsp;{{trans('profile.specializations.pending')}}</label>
                <div class="col-md-6">
                    <select multiple="multiple"
                            class="form-control{{ $errors->has('specializations') ? ' is-invalid' : '' }}"
