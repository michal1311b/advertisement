                    ...
                    @if(Auth::user() && Auth::user()->hasRole('admin'))
                        <div class="col-md-12">
                            <div class="btn-group btn-group-toggle py-2">
                                <a href="{{ route('edit-advertisement', $advertisement->id) }}" class="btn btn-rounded btn-info border border-warning mr-2 text-white" title="{{ trans('sentence.edit') }}">{{ trans('sentence.edit') }}</a>
