        ...
        <form @submit.prevent="handleSubmit(submitForm)" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label for="phone" class="col-12 col-md-3 col-form-label text-md-right">
                    {{ trans('sentence.phone') }} <span class="text-danger font-weight-bolder">*</span>
                </label>
            ...
            <div class="form-group row mb-0">
                ...
                <div class="col-6">
                    <a class="btn btn-rounded btn-warning" @click="createAgain" v-if="showCreateSmiilarBtn">{{ trans('buttons.create-again-btn') }}</a>
                </div>
            </div>
        </form>
    </ValidationObserver>
